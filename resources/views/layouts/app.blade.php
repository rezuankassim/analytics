...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="sans bg-gray-200 text-gray-700 overflow-x-hidden">
        @auth
            <div class="h-screen flex">
                <div class="flex flex-shrink-0 flex-col w-56 bg-white border border-gray-300">
                    ...
                    <a href="{{ route('projects.index') }}" class="block border-r-2 text-md text-gray-800 px-4 py-2 hover:bg-gray-200 @if(Route::is('projects.*')) border-green-500 font-semibold @else border-transparent @endif">
                        <div class="flex">
                            <svg class="stroke-current @if(Route::is('projects.*')) text-green-500 @else text-gray-500 @endif" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"><path d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                            <span class="ml-4 flex-1">Projects</span>
                        </div>
                    </a> 
                    ...
                    <a href="{{ route('apps.index') }}" class="block border-r-2 text-md text-gray-800 px-4 py-2 hover:bg-gray-200 @if(Route::is('apps.*')) border-green-500 font-semibold @else border-transparent @endif">
                        <div class="flex">
                            <svg class="w-6 h-6 stroke-current @if(Route::is('apps.*')) text-green-500 @else text-gray-500 @endif"xmlns="http://www.w3.org/2000/svg" fill="none"><path d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                            
                            <span class="ml-4 flex-1">Apps</span>
                        </div>
                    </a> 
                </div>
        ...
        @else
            <div class="flex items-center bg-white shadow px-4 py-4">
                <a href="{{ route('welcome') }}" class="text-lg tracking-wider flex-1 text-gray-900">
